...
JVM_ADDITIONAL_PARAMS="-Xms512m -Xmx2g -XX:+HeapDumpOnOutOfMemoryError --add-exports java.naming/com.sun.jndi.ldap=ALL-UNNAMED -Dfile.encoding=UTF-8 -Dcom.sun.jndi.ldap.connect.pool.timeout=60000 -Dlog4j.configurationFile=${EXECUTION_PATH}/conf/log4j2.xml -javaagent:${EXECUTION_PATH}/lib/org.jolokia-jolokia-jvm.jar=port=8778,host=0.0.0.0"
