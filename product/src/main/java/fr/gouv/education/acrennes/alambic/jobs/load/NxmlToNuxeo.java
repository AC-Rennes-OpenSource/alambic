        ...
        for (final Element doc : documents) {
            ...
            try {
                ...
                if (doc.getChild("clean") != null) {
                    for (final Element docToClean : doc.getChild("clean").getChildren()) {
                ...
                for (final Element nxImport : doc.getChildren("import")) {
                    fileImport(nxDoc.getPath(), nxImport);
                }

                // Lancement des processus de copy
                for (final Element path : doc.getChildren("copy")) {
