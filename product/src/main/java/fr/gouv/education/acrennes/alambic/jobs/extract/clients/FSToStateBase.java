            ...
            try {
                ...
                if (root.isDirectory()) {
                    ...
                    for (File file : list) {
                        ...
                        map.put("isFile", List.of(Boolean.toString(file.isFile())));
                        map.put("isDirectory", List.of(Boolean.toString(file.isDirectory())));
                        map.put("isHidden", List.of(Boolean.toString(file.isHidden())));
                        stateBase.add(map);
                    }
                } else {
