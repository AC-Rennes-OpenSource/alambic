 ...
 *       &lt;sequence>
 *         &lt;element name="GARRespAff" type="{http://data.education.fr/ns/gar/1d}GARRespAff" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
public class GARENTRespAff {
    ...
    @XmlElement(name = "GARRespAff")
    protected List<GARRespAff> garRespAff;
