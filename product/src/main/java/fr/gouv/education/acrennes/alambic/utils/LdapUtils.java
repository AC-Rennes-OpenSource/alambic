...
public class LdapUtils {
    ...
    public static int compareAttributes(final Attribute attrA, final Attribute attrB, final boolean caseSensitive)
     ...
     */
    public static List<String> positiveDelta(final Attribute leftAttr, final Attribute rightAttr)
            throws NamingException, UnsupportedEncodingException {
    ...
    public static boolean attributeContainsValues(final Attribute attr, final NamingEnumeration<?> listValues, final boolean caseSensitive)
            throws NamingException, UnsupportedEncodingException {
        boolean test = true;
    ...
    public static boolean attributeContainsValue(final Attribute attr, final String attendedValue)
            throws NamingException, UnsupportedEncodingException {
    ...
    public static boolean attributeContainsValueAllowRegExp(final Attribute attr, final Object value)
            throws NamingException, UnsupportedEncodingException {
        NamingEnumeration<?> values = attr.getAll();
        try {
            boolean test = false;
