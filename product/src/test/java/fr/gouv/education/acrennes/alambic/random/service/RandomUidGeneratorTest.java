...
public class RandomUidGeneratorTest {
	...
	public void test1() {
		try {
			...
			rg = rgs.getRandomGenerator(GENERATOR_TYPE.UID);

			List<RandomEntity> entities = rg.getEntities("{\"count\":1,\"firstName\":\"Yann\",\"lastName\":\"Le Cleac'h\"}", "PROCESS_TESTU", UNICITY_SCOPE.PROCESS);
	...
	public void test2() {
		try {
			...
			List<RandomEntity> entities = rg.getEntities("{\"count\":1,\"firstName\":\"Yann\",\"lastName\":\"Le Cleac'h\",\"reuse\":\"false\",\"blurid\":\"56\"}", "PROCESS_TESTU", UNICITY_SCOPE.PROCESS);
			String firstEntity = entities.get(0).getJson();
			
			entities = rg.getEntities("{\"count\":1,\"firstName\":\"Yann\",\"lastName\":\"Le Cleac'h\",\"reuse\":\"false\",\"blurid\":\"56\"}", "PROCESS_TESTU", UNICITY_SCOPE.PROCESS);
	...
	public void test3() {
		try {
			...
			List<RandomEntity> entities = rg.getEntities("{\"count\":1,\"firstName\":\"Yann\",\"lastName\":\"Le Cleac'h\",\"reuse\":\"true\",\"blurid\":\"56\"}", "PROCESS_TESTU", UNICITY_SCOPE.PROCESS);
			String firstEntity = entities.get(0).getJson();
			
			entities = rg.getEntities("{\"count\":1,\"firstName\":\"Yann\",\"lastName\":\"Le Cleac'h\",\"reuse\":\"true\",\"blurid\":\"56\"}", "PROCESS_TESTU", UNICITY_SCOPE.PROCESS);
			String secondEntity = entities.get(0).getJson();
	...
	public void test4() {
		try {
			...
			List<RandomEntity> entities = rg.getEntities("{\"count\":1,\"firstName\":\"Yann\",\"lastName\":\"Le Cleac'h\",\"reuse\":\"false\",\"blurid\":\"56\"}", "PROCESS_TESTU_A", UNICITY_SCOPE.PROCESS);
			String firstEntity = entities.get(0).getJson();
			
			entities = rg.getEntities("{\"count\":1,\"firstName\":\"Yann\",\"lastName\":\"Le Cleac'h\",\"reuse\":\"false\",\"blurid\":\"56\"}", "PROCESS_TESTU_B", UNICITY_SCOPE.PROCESS);
			String secondEntity = entities.get(0).getJson();
	...
	public void test5() {
		try {
			...
			List<RandomEntity> entities = rg.getEntities("{\"count\":1,\"format\":\"SHORT\",\"firstName\":\"Yann\",\"lastName\":\"Le Cleac'h\",\"reuse\":\"false\",\"blurid\":\"56\"}", "PROCESS_TESTU", UNICITY_SCOPE.PROCESS);
			String firstEntity = entities.get(0).getJson();
			
			entities = rg.getEntities("{\"count\":1,\"format\":\"SHORT\",\"firstName\":\"Yann\",\"lastName\":\"Le Cleac'h\",\"reuse\":\"false\",\"blurid\":\"56\"}", "PROCESS_TESTU", UNICITY_SCOPE.PROCESS);
			String secondEntity = entities.get(0).getJson();
