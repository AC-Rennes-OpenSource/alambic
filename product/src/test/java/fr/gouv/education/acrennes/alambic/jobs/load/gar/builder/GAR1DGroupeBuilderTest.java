...
public class GAR1DGroupeBuilderTest extends GAR1DBuilderTestUtils {
    ...
    public static void persistEntities() throws AlambicException {
        ...
        persistedEntities.add(new PersonGroupeEntity(PersonGroupeEntity.PERSON_TYPE.TEACHER, "0351234A", "b6cb58e9-00c8-48db-b8bf-c02b6726c153",
                "43770"));
        persistedEntities.add(new PersonGroupeEntity(PersonGroupeEntity.PERSON_TYPE.STUDENT, "0351234A", "89bed3a9-ce5c-4e0d-8f1c-c5615d40b91b",
                "43770"));
        persistedEntities.add(new PersonGroupeEntity(PersonGroupeEntity.PERSON_TYPE.STUDENT, "0351234A", "48cd50d2-1796-4a59-b681-d3cc9d099bbb",
                "43770"));
        persistedEntities.add(new PersonGroupeEntity(PersonGroupeEntity.PERSON_TYPE.STUDENT, "0351234A", "6120db3f-bc15-4439-b6fa-c2ace93df676",
                "43770"));
        persistedEntities.add(new PersonGroupeEntity(PersonGroupeEntity.PERSON_TYPE.STUDENT, "0351234A", "066d9d0a-f4b4-4adc-a145-f089e7230caa",
                "43770"));
        persistedEntities.add(new PersonGroupeEntity(PersonGroupeEntity.PERSON_TYPE.TEACHER, "0351234A", "29cb4aab-523d-4ca7-9ccf-8a23f3f5e4a2",
                "43771"));
        persistedEntities.add(new PersonGroupeEntity(PersonGroupeEntity.PERSON_TYPE.STUDENT, "0351234A", "6a89a236-7e09-4cdf-bfa9-033e160dc3fa",
                "43771"));
        persistedEntities.add(new PersonGroupeEntity(PersonGroupeEntity.PERSON_TYPE.STUDENT, "0351234A", "0d0e964f-7d71-475d-ad1f-f30980eab945",
                "43771"));
        persistedEntities.add(new PersonGroupeEntity(PersonGroupeEntity.PERSON_TYPE.STUDENT, "0351234A", "092e2723-f85b-4d80-b78e-65b91b062918",
                "43771"));
        persistedEntities.add(new PersonGroupeEntity(PersonGroupeEntity.PERSON_TYPE.STUDENT, "0351234A", "a2589231-a9f7-4c35-bd73-4b776ab1fda7",
                "43771"));
        persistedEntities.add(new PersonGroupeEntity(PersonGroupeEntity.PERSON_TYPE.TEACHER, "0351234A", "052f50b2-1ebe-4e70-9b6c-4f641df472bb",
                "43773"));
        persistedEntities.add(new PersonGroupeEntity(PersonGroupeEntity.PERSON_TYPE.STUDENT, "0351234A", "28727473-6dc4-4940-928c-03e66d01316f",
                "43773"));
        persistedEntities.add(new PersonGroupeEntity(PersonGroupeEntity.PERSON_TYPE.STUDENT, "0351234A", "edf4246d-00a4-45cf-ad4f-1160d5d54419",
                "43773"));
        persistedEntities.add(new PersonGroupeEntity(PersonGroupeEntity.PERSON_TYPE.STUDENT, "0351234A", "84f80ee6-4e8f-4ac1-a715-89f78e989e79",
                "43773"));
        persistedEntities.add(new PersonGroupeEntity(PersonGroupeEntity.PERSON_TYPE.STUDENT, "0351234A", "0a041af0-fb42-4d92-9dce-61f3dc03a3dc",
                "43773"));
        persistedEntities.add(new PersonGroupeEntity(PersonGroupeEntity.PERSON_TYPE.STUDENT, "0351234A", "0e41c7ae-bb5d-4bf6-abdb-80b991c74de9",
                "43773"));
        persistedEntities.add(new PersonGroupeEntity(PersonGroupeEntity.PERSON_TYPE.TEACHER, "0354321B", "5624a719-df8d-450f-9747-4f7168f84ca8",
                "1337"));
    ...
    private void mockWriter() throws FileNotFoundException, JAXBException {
        ...
        PowerMockito.doAnswer(invocationOnMock -> {
            Object argument = invocationOnMock.getArgument(0, Object.class);
            ...
            return null;
        }).when(writer).add(nullable(Object.class));
    }
    ...
    private void assertGroupeListEquals(List<GARGroupe> expected, List<GARGroupe> actual) {
        List<GARGroupe> workExpected =
                expected.stream().sorted(Comparator.comparing(GARGroupe::getGARStructureUAI).thenComparing(GARGroupe::getGARGroupeCode)).collect(Collectors.toList());
        List<GARGroupe> workActual =
                actual.stream().sorted(Comparator.comparing(GARGroupe::getGARStructureUAI).thenComparing(GARGroupe::getGARGroupeCode)).collect(Collectors.toList());
        for (int i = 0; i < workExpected.size(); i++) {
            ...
            assertListEquals(workExpected.get(i).getGARGroupeDivAppartenance(), workActual.get(i).getGARGroupeDivAppartenance(),
                    this::assertStringListEquals);
        }
    }
