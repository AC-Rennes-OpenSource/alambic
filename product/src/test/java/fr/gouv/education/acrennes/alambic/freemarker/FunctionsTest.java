...
public class FunctionsTest {
    ...
    public void test1() {
        try {
            ...
            final String value = Functions.getInstance().executeAllFunctions("(UNICITY)ldap://ldap-pp.in.ac-rennes.fr:389/ou=personnes," +
                                                                             "dc=ent-bretagne,dc=fr??sub?(mail=gabriel.faure*@ac-rennes.fr)" +
                                                                             "(/UNICITY)");
    ...
    public void test5() {
        try {
            PowerMockito.when(mockedDirContext.search(nullable(String.class), nullable(String.class), nullable(SearchControls.class))).
                    thenReturn(getResultSet(new String[] { "mail=gabriel.faure@ac-rennes.fr", "mail=gabriel.faure2@ac-rennes.fr", "mail=gabriel" +
                                                                                                                                  ".faure3@ac" +
                                                                                                                                  "-rennes.fr" }));
    ...
    public void test6() {
        try {
            PowerMockito.when(mockedDirContext.search(nullable(String.class), nullable(String.class), nullable(SearchControls.class))).
                    thenReturn(getResultSet(new String[] { "mail=gabriel.faure@ac-rennes.fr", "mail=gabriel.faure1@ac-rennes.fr", "mail=gabriel" +
                                                                                                                                  ".faure2@ac" +
                                                                                                                                  "-rennes.fr" }));
    ...
    public void test8() {
        try {
            ...
            final String value = Functions.getInstance().executeAllFunctions("(UNICITY)ldap://ldap-pp.in.ac-rennes.fr:389/ou=personnes," +
                                                                             "dc=ent-bretagne,dc=fr??sub?(&(objectClass=ENTPerson)(mail=gabriel" +
                                                                             ".faure*@ac-rennes.fr))(/UNICITY)");
            Assert.assertEquals("gabriel.faure3@ac-rennes.fr", value);
        } catch (final Exception e) {
            System.out.println(e.getMessage());
            Assert.fail();
    ...
    public void test10() {
        try {
            ...
            final String value = Functions.getInstance().executeAllFunctions("(UNICITY)ldap://ldap-pp.in.ac-rennes.fr:389/ou=personnes," +
                                                                             "dc=ent-bretagne,dc=fr?(&(mail=gabriel.faure*@ac-rennes.fr)" +
                                                                             "(objectClass=ENTPerson))(/UNICITY)");
    ...
    public void test11() {
        try {
            PowerMockito.when(mockedDirContext.search(nullable(String.class), nullable(String.class), nullable(SearchControls.class))).
                    thenReturn(getResultSet(new String[] { "mail=maria-teresa.cancelinha@ac-rennes.fr", "mailEquivalentAddress=maria-teresa" +
                                                                                                        ".cancelinha1@ac-rennes.fr" }));

            final String value = Functions.getInstance().executeAllFunctions("(UNICITY)ldap://ldap.ac-rennes.fr:389/ou=ac-rennes,ou=education," +
                                                                             "o=gouv,c=fr??sub?(|(mail=maria-teresa.cancelinha*@ac-rennes.fr)" +
                                                                             "(mailEquivalentAddress=maria-teresa.cancelinha*@ac-rennes.fr)))" +
                                                                             "(/UNICITY)");
    ...
    public void test12() {
        try {
            PowerMockito.when(mockedDirContext.search(nullable(String.class), nullable(String.class), nullable(SearchControls.class))).
                    thenReturn(getResultSet(new String[] { "mail=maria-teresa.cancelinha@ac-rennes.fr,maria-teresa.cancelinha2@ac-rennes.fr",
                            "mailEquivalentAddress=maria-teresa.cancelinha1@ac-rennes.fr" }));
    ...
    public void test13() {
        try {
            PowerMockito.when(mockedDirContext.search(nullable(String.class), nullable(String.class), nullable(SearchControls.class))).
                    thenReturn(getResultSet(new String[] { "mail=maria-teresa.cancelinha@ac-rennes.fr,maria-teresa.cancelinha2@ac-rennes.fr;" +
                                                           "mailEquivalentAddress=maria-teresa.cancelinha3@ac-rennes.fr",
    ...
    public void test16() {
        try {
            ...
            PowerMockito.when(mockedDirContext.search(nullable(String.class), nullable(String.class), nullable(SearchControls.class))).
                    thenReturn(getResultSet(new String[] { "ENTPersonUid=" + mockedUUID1 })).
                    thenReturn(getResultSet(new String[] { "ENTPersonUid=" + mockedUUID2 })).
                    thenReturn(null);

            final String uuid = Functions.getInstance().executeAllFunctions("(UNICITY)ldap://ldap-int.in.ac-rennes.fr:389/ou=personnes," +
                                                                            "dc=ent-bretagne,dc=fr??sub?(ENTPersonUid=(UUID) (/UUID)*)(/UNICITY)");
    ...
    public void test17() {
        try {
            PowerMockito.when(mockedDirContext.search(nullable(String.class), nullable(String.class), nullable(SearchControls.class))).
                    thenReturn(getResultSet(new String[] { "employeeNumber=14V0000001EXT", "employeeNumber=14V0000002EXT", "employeeNumber" +
                                                                                                                           "=14V0000003EXT" }));

            final String value = Functions.getInstance().executeAllFunctions("(UNICITY)candidate=\"(STRINGFORMAT)pattern=%07d;values=(INCREMENT)1" +
                                                                             "(/INCREMENT);types=Integer(/STRINGFORMAT)\"|search=ldap://ldap-pp.in" +
                                                                             ".ac-rennes.fr:389/ou=personnes,dc=ent-bretagne,dc=fr??sub?" +
                                                                             "(employeeNumber=14V*EXT)(/UNICITY)");
    ...
    public void test18() {
        try {
            ...
            final String value = Functions.getInstance().executeAllFunctions("(UNICITY)candidate=\"(STRINGFORMAT)pattern=%07d;values=(INCREMENT)1" +
                                                                             "(/INCREMENT);types=Integer(/STRINGFORMAT)\"," +
                                                                             "login=\"cn=TechnicalPrincipal\"," +
                                                                             "password=\"TopSecret\"|search=ldap://ldap-pp.in.ac-rennes" +
                                                                             ".fr:389/ou=personnes,dc=ent-bretagne,dc=fr??sub?(&amp;(fonctm=EXTACA)" +
                                                                             "(employeeNumber=14V*EXT))(/UNICITY)");
    ...
    public void test19() throws NamingException, AlambicException {
        ...
        Functions.getInstance().executeAllFunctions("(UNICITY)candidate=\"(STRINGFORMAT)pattern=%07d;values=(INCREMENT)1(/INCREMENT);types=Integer" +
                                                    "(/STRINGFORMAT)\",login=\"cn=TechnicalPrincipal\",password=\"TopSecret\"|search=ldap://ldap-pp" +
                                                    ".in.ac-rennes.fr:389/ou=personnes,dc=ent-bretagne,dc=fr??sub?(&amp;(fonctm=EXTACA)" +
                                                    "(employeeNumber=14V*EXT))(/UNICITY)");
    }
