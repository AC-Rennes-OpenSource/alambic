...
public class ReportUnmarshallerTest {
	...
	public void test1() throws JAXBException {
		...
		Report report = unmarshaller.unmarshall("{ \"report\":{ \"status\":\"success\", \"activity\":{ \"job_name\":\"my_job\", \"status\":\"COMPLETED\", \"traffic_light\":\"GREEN\", \"progress\":100, \"duration\":236, \"inner_jobs\":[ ] } } }");
		assertEquals(Report.STATUS.success, Report.STATUS.valueOf(report.getStatus()));
		assertEquals(null, report.getReasons());
	...
	public void test2() throws JAXBException {
		ReportUnmarshaller unmarshaller = new ReportUnmarshaller();
		Report report = unmarshaller.unmarshall("{ \"report\":{ \"status\":\"error\", \"reasons\":[\"Oups!\"], \"activity\":{ \"job_name\":\"my_job\", \"status\":\"COMPLETED\", \"traffic_light\":\"RED\", \"progress\":100, \"duration\":236, \"inner_jobs\":[ ] } } }");
	...
	public void test3() throws JAXBException {
		ReportUnmarshaller unmarshaller = new ReportUnmarshaller();
		Report report = unmarshaller.unmarshall("{ \"report\":{ \"status\":\"error\", \"reasons\":[\"Oups!\"], \"activity\":{ \"job_name\":\"my_job\", \"status\":\"COMPLETED\", \"traffic_light\":\"RED\", \"progress\":100, \"duration\":236, \"inner_jobs\":[ { \"job_name\":\"my_inner_job_1\", \"status\":\"COMPLETED\", \"traffic_light\":\"GREEN\", \"progress\":100, \"duration\":74, \"inner_jobs\":[] }, { \"job_name\":\"my_inner_job_2\", \"status\":\"COMPLETED\", \"traffic_light\":\"RED\", \"progress\":100, \"duration\":162, \"inner_jobs\":[] } ] } } }");
		assertEquals(Report.STATUS.error, Report.STATUS.valueOf(report.getStatus()));
		assertEquals(1, report.getReasons().size());
		assertEquals("Oups!", report.getReasons().get(0));
		assertEquals("my_job", report.getActivity().getJob_name());
