...
public class RandomUserGeneratorTest {
    ...
    private void setUpPersistenceData() throws AlambicException, IOException {
        ...
        try {
            ...
            for (int i = 0; i < children.length; i++) {
                ...
                for (JsonNode node : dictionaryNode) {
                    RandomDictionaryEntityPK.IDENTITY_ELEMENT element =
                            RandomDictionaryEntityPK.IDENTITY_ELEMENT.valueOf(node.get("element").textValue().toUpperCase());
    ...
    public void test1() {
        try {
            List<RandomEntity> entities = rg.getEntities("{\"blurid\":\"1\",\"gender\":\"female\",\"count\":2}", "PROCESS_TESTU",
    ...
    public void test2() {
        try {
            List<RandomEntity> entities = rg.getEntities("{\"blurid\":\"1\",\"gender\":\"female\",\"count\":9}", "PROCESS_TESTU",
                    UNICITY_SCOPE.PROCESS);
    ...
    public void test4() {
        try {
            List<RandomEntity> entities = rg.getEntities("{\"blurid\":\"1\",\"gender\":\"female\",\"count\":7}", "PROCESS_TESTU",
                    UNICITY_SCOPE.PROCESS);
    ...
    public void test5() {
        try {
            List<RandomEntity> entities = rg.getEntities("{\"blurid\":\"1\",\"gender\":\"female\",\"count\":7}", "PROCESS_TESTU_A",
                    UNICITY_SCOPE.PROCESS);
            Assert.assertEquals(7, entities.size());
    ...
    public void test9() {
        try {
            List<RandomEntity> firstCallEntities = rg.getEntities("{\"blurid\":\"1\",\"gender\":\"female\",\"count\":2, \"reuse\":\"true\"}",
                    "PROCESS_TESTU", UNICITY_SCOPE.PROCESS);
            Assert.assertEquals(2, firstCallEntities.size());

            List<RandomEntity> secondCallEntities = rg.getEntities("{\"blurid\":\"1\",\"gender\":\"female\",\"count\":2, \"reuse\":\"true\"}",
                    "PROCESS_TESTU", UNICITY_SCOPE.PROCESS);
            Assert.assertEquals(2, secondCallEntities.size());

            Assert.assertEquals(firstCallEntities.toString(), secondCallEntities.toString());
        } catch (AlambicException e) {
            Assert.fail(e.getMessage());
        }
    }
    ...
    public void test10() {
        try {
            List<RandomEntity> firstCallEntities = rg.getEntities("{\"blurid\":\"1\",\"gender\":\"female\",\"count\":1, \"reuse\":\"true\"}",
                    "PROCESS_TESTU", UNICITY_SCOPE.PROCESS);
            Assert.assertEquals(1, firstCallEntities.size());

            List<RandomEntity> secondCallEntities = rg.getEntities("{\"blurid\":\"2\",\"gender\":\"female\",\"count\":1, \"reuse\":\"true\"}",
                    "PROCESS_TESTU", UNICITY_SCOPE.PROCESS);
            Assert.assertEquals(1, secondCallEntities.size());

            Assert.assertNotEquals(firstCallEntities.toString(), secondCallEntities.toString());
        } catch (AlambicException e) {
            Assert.fail(e.getMessage());
        }
    }
    ...
    public void test11() {
        try {
            List<RandomEntity> firstCallEntities = rg.getEntities("{\"blurid\":\"1\",\"gender\":\"female\",\"count\":1, \"reuse\":\"true\"}",
                    "PROCESS_TESTU_A", UNICITY_SCOPE.PROCESS);
            Assert.assertEquals(1, firstCallEntities.size());

            List<RandomEntity> secondCallEntities = rg.getEntities("{\"blurid\":\"1\",\"gender\":\"female\",\"count\":1, \"reuse\":\"true\"}",
    ...
    public void test12() {
        try {
            List<RandomEntity> firstCallEntities = rg.getEntities("{\"blurid\":\"1\",\"gender\":\"female\",\"count\":1, \"reuse\":\"true\"}",
                    "PROCESS_TESTU_A", UNICITY_SCOPE.NONE);
            Assert.assertEquals(1, firstCallEntities.size());

            List<RandomEntity> secondCallEntities = rg.getEntities("{\"blurid\":\"1\",\"gender\":\"female\",\"count\":1, \"reuse\":\"true\"}",
                    "PROCESS_TESTU_B", UNICITY_SCOPE.NONE);
            Assert.assertEquals(1, secondCallEntities.size());
    ...
    public void test14() {
        try {
            List<RandomEntity> firstCallEntities = rg.getEntities("{\"blurid\":\"1\",\"gender\":\"female\",\"count\":1, \"reuse\":\"true\"}",
                    "PROCESS_TESTU_A", UNICITY_SCOPE.PROCESS_ALL);
            Assert.assertEquals(1, firstCallEntities.size());

            List<RandomEntity> secondCallEntities = rg.getEntities("{\"blurid\":\"1\",\"gender\":\"female\",\"count\":1, \"reuse\":\"true\"}",
                    "PROCESS_TESTU_B", UNICITY_SCOPE.PROCESS_ALL);
            Assert.assertEquals(1, secondCallEntities.size());
