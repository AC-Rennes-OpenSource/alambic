...
public class RandomMailGeneratorTest {
    ...
    public void test1() {
        try {
            List<RandomEntity> entities = rg.getEntities("{\"blurid\":\"1\",\"count\":1,\"firstName\":\"Yann\",\"lastName\":\"Le Cleac'h\"," +
                                                         "\"domain\":\"noreply.phm.education.gouv.fr\"}", "PROCESS_TESTU", UNICITY_SCOPE.PROCESS);
    ...
    public void test2() {
        try {
            List<RandomEntity> entities = rg.getEntities("{\"blurid\":\"1\",\"reuse\":\"false\",\"count\":1,\"firstName\":\"Yann\"," +
                                                         "\"lastName\":\"Le Cleac'h\",\"domain\":\"noreply.phm.education.gouv.fr\"}",
                    "PROCESS_TESTU", UNICITY_SCOPE.PROCESS);
            String firstEntity = entities.get(0).getJson();

            entities = rg.getEntities("{\"blurid\":\"1\",\"reuse\":\"false\",\"count\":1,\"firstName\":\"Yann\",\"lastName\":\"Le Cleac'h\"," +
                                      "\"domain\":\"noreply.phm.education.gouv.fr\"}", "PROCESS_TESTU", UNICITY_SCOPE.PROCESS);
    ...
    public void test3() {
        try {
            List<RandomEntity> entities = rg.getEntities("{\"blurid\":\"1\",\"reuse\":\"false\",\"count\":1,\"firstName\":\"Yann\"," +
                                                         "\"lastName\":\"Le Cleac'h\",\"domain\":\"noreply.phm.education.gouv.fr\"}",
                    "PROCESS_TESTU_1", UNICITY_SCOPE.PROCESS_ALL);
            String firstEntity = entities.get(0).getJson();

            entities = rg.getEntities("{\"blurid\":\"1\",\"reuse\":\"false\",\"count\":1,\"firstName\":\"Yann\",\"lastName\":\"Le Cleac'h\"," +
                                      "\"domain\":\"noreply.phm.education.gouv.fr\"}", "PROCESS_TESTU_2", UNICITY_SCOPE.PROCESS_ALL);
            String secondEntity = entities.get(0).getJson();

            entities = rg.getEntities("{\"blurid\":\"1\",\"reuse\":\"false\",\"count\":1,\"firstName\":\"Yann\",\"lastName\":\"Le Cleac'h\"," +
                                      "\"domain\":\"noreply.phm.education.gouv.fr\"}", "PROCESS_TESTU_3", UNICITY_SCOPE.PROCESS_ALL);
            String thirdEntity = entities.get(0).getJson();
    ...
    public void test4() {
        try {
            List<RandomEntity> entities = rg.getEntities("{\"blurid\":\"1\",\"reuse\":\"false\",\"count\":1,\"firstName\":\"Yann\"," +
                                                         "\"lastName\":\"Le Cleac'h\",\"domain\":\"noreply.phm.education.gouv.fr\"}",
                    "PROCESS_TESTU_1", UNICITY_SCOPE.NONE);
            String firstEntity = entities.get(0).getJson();

            entities = rg.getEntities("{\"blurid\":\"1\",\"reuse\":\"false\",\"count\":1,\"firstName\":\"Yann\",\"lastName\":\"Le Cleac'h\"," +
                                      "\"domain\":\"noreply.phm.education.gouv.fr\"}", "PROCESS_TESTU_2", UNICITY_SCOPE.NONE);
            String secondEntity = entities.get(0).getJson();

            entities = rg.getEntities("{\"blurid\":\"1\",\"reuse\":\"false\",\"count\":1,\"firstName\":\"Yann\",\"lastName\":\"Le Cleac'h\"," +
                                      "\"domain\":\"noreply.phm.education.gouv.fr\"}", "PROCESS_TESTU_3", UNICITY_SCOPE.NONE);
            String thirdEntity = entities.get(0).getJson();
    ...
    public void test5() {
        try {
            List<RandomEntity> entities = rg.getEntities("{\"blurid\":\"1\",\"reuse\":\"true\",\"count\":1,\"firstName\":\"Yann\",\"lastName\":\"Le" +
                                                         " Cleac'h\",\"domain\":\"noreply.phm.education.gouv.fr\"}", "PROCESS_TESTU",
                    UNICITY_SCOPE.PROCESS);
            String firstEntity = entities.get(0).getJson();

            entities = rg.getEntities("{\"blurid\":\"1\",\"reuse\":\"true\",\"count\":1,\"firstName\":\"Yann\",\"lastName\":\"Le Cleac'h\"," +
                                      "\"domain\":\"noreply.phm.education.gouv.fr\"}", "PROCESS_TESTU", UNICITY_SCOPE.PROCESS);
            String secondEntity = entities.get(0).getJson();
