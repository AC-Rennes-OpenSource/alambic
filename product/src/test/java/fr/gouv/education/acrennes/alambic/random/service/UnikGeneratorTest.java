...
public class UnikGeneratorTest {
    ...
    public void test1() {
        try {
            List<RandomEntity> entities = rg.getEntities("{\"count\":1,\"reuse\":\"true\",\"firstName\":\"Yann\"," +
                                                         "\"lastName\":\"Andrianirinaharivelo\",\"blurid\":\"123456\"}", "PROCESS_TESTU",
    ...
    public void test2() {
        try {
            List<RandomEntity> entities = rg.getEntities("{\"count\":1,\"firstName\":\"Yann\",\"lastName\":\"Le Cleac'h\",\"reuse\":\"true\"," +
                                                         "\"blurid\":\"123456\"}", "PROCESS_TESTU", UNICITY_SCOPE.PROCESS);
            String firstEntity = entities.get(0).getJson();

            entities = rg.getEntities("{\"count\":1,\"firstName\":\"Yann\",\"lastName\":\"Le Cleac'h\",\"reuse\":\"true\",\"blurid\":\"123456\"}",
                    "PROCESS_TESTU", UNICITY_SCOPE.PROCESS);
            String secondEntity = entities.get(0).getJson();

            entities = rg.getEntities("{\"count\":1,\"firstName\":\"Yann\",\"lastName\":\"Le Cleac'h\",\"reuse\":\"true\",\"blurid\":\"789123\"}",
                    "PROCESS_TESTU", UNICITY_SCOPE.PROCESS);
    ...
    public void test3() {
        try {
            List<RandomEntity> entities = rg.getEntities("{\"count\":1,\"firstName\":\"Jean Marc\",\"lastName\":\"Le Meur - Bellec\"," +
                                                         "\"reuse\":\"true\",\"blurid\":\"5723456\"}", "PROCESS_TESTU", UNICITY_SCOPE.PROCESS);
            String firstEntity = entities.get(0).getJson();

            entities = rg.getEntities("{\"count\":1,\"firstName\":\"Louis-André\",\"lastName\":\"Martin--Coïc\",\"reuse\":\"true\"," +
                                      "\"blurid\":\"123411\"}", "PROCESS_TESTU", UNICITY_SCOPE.PROCESS);
            String secondEntity = entities.get(0).getJson();

            entities = rg.getEntities("{\"count\":1,\"firstName\":\"Théo\",\"lastName\":\"L'hélias\",\"reuse\":\"true\",\"blurid\":\"785523\"}",
                    "PROCESS_TESTU", UNICITY_SCOPE.PROCESS);
            String thirdEntity = entities.get(0).getJson();
