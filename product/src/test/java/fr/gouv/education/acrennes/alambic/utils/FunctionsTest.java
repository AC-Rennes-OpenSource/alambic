...
public class FunctionsTest {
	...
	// @Test
	// public void test4() {
	// final String params = "UnMotDePasseCompliqué!";
	// final String hashedMDP = Functions.getInstance().executeAllFunctions("{SHA}(B64SHA1)" + params + "(/B64SHA1)");
	// Assert.assertEquals("{SHA}wuDf/ZoyYFh7NM+hnV0J33R4nnw=", hashedMDP);
	// }
	//
	// @Test
	// public void test5() {
	// final String params = "plaintext=UnMotDePasseCompliqué!,algorithm=SHA-256";
	// final String hashedMDP = Functions.getInstance().executeAllFunctions("{SHA-256}(B64SHAx)" + params + "(/B64SHAx)");
	// Assert.assertEquals("{SHA-256}Le98FBmgie46mVGGsYAM+EH6YTrJevKH+AlKXjciFeU=", hashedMDP);
	// }
	//
	// @Test
	// public void test6() {
	...
	@Test
	public void test15() throws AlambicException {
