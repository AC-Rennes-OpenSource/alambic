...
public class FunctionsTest {
    ...
    public void test2() throws AlambicException {
        ...
        final String encryptedText = Functions.getInstance().executeAllFunctions("(CIPHER)mode=ENCRYPT_MODE,algorithm=RSA,path=" +
                                                                                 "./src/test/resources/data/security/alambic.keystore," +
                                                                                 "ksPwd=testpass,ksType=JCEKS,alias=aliasrsa1024,keyPwd=testpass," +
                                                                                 "keyType=public,plaintext=" + MDP + "(/CIPHER)");
        Assert.assertEquals(MDP, Functions.getInstance().executeAllFunctions("(CIPHER)mode=DECRYPT_MODE,algorithm=RSA,path=" +
                                                                             "./src/test/resources/data/security/alambic.keystore,ksPwd=testpass," +
                                                                             "ksType=JCEKS,alias=aliasrsa1024,keyPwd=testpass,keyType=private," +
                                                                             "plaintext=" + encryptedText + "(/CIPHER)"));
    }

    @Test
    public void test3() throws AlambicException {
        final String MDP = "Le mot de passe à chiffrer avec AES";
        final String encryptedText = Functions.getInstance().executeAllFunctions("(CIPHER)mode=ENCRYPT_MODE,algorithm=AES,path=" +
                                                                                 "./src/test/resources/data/security/alambic.keystore," +
                                                                                 "ksPwd=testpass,ksType=JCEKS,alias=aliasaes128,keyPwd=testpass," +
                                                                                 "keyType=secret,plaintext=" + MDP + "(/CIPHER)");
        Assert.assertEquals(MDP, Functions.getInstance().executeAllFunctions("(CIPHER)mode=DECRYPT_MODE,algorithm=AES,path=" +
                                                                             "./src/test/resources/data/security/alambic.keystore,ksPwd=testpass," +
                                                                             "ksType=JCEKS,alias=aliasaes128,keyPwd=testpass,keyType=secret," +
                                                                             "plaintext=" + encryptedText + "(/CIPHER)"));
    }

    @Test
    public void test4() throws AlambicException {
        final String params = "plaintext=(CIPHER)mode=DECRYPT_MODE,algorithm=AES,path=./src/test/resources/data/security/alambic.keystore," +
                              "ksPwd=testpass,ksType=JCEKS,alias=aliasaes128,keyPwd=testpass,keyType=secret," +
                              "plaintext=zDU5J8Tw7Pd7ftMthM4a4r5pzaRWTHc/20ekKlNCsVPG4zOpCxpPb9ZSfp4jTgwf(/CIPHER),algorithm= SHA-256";
    ...
    public void test5() throws AlambicException {
        ...
        final String encryptedText = Functions.getInstance().executeAllFunctions("(CIPHER)mode=ENCRYPT_MODE,algorithm=RSA,path=" +
                                                                                 "./src/test/resources/data/security/alambic.keystore," +
                                                                                 "ksPwd=testpass,ksType=JCEKS,alias=aliasrsa2048,keyPwd=testpass," +
                                                                                 "keyType=public,plaintext=" + MDP + "(/CIPHER)");
        Assert.assertEquals(MDP, Functions.getInstance().executeAllFunctions("(CIPHER)mode=DECRYPT_MODE,algorithm=RSA,path=" +
                                                                             "./src/test/resources/data/security/alambic.keystore,ksPwd=testpass," +
                                                                             "ksType=JCEKS,alias=aliasrsa2048,keyPwd=testpass,keyType=private," +
                                                                             "plaintext=" + encryptedText + "(/CIPHER)"));
    }

    @Test
    public void test6() throws AlambicException {
        final String actual = Functions.getInstance().executeAllFunctions("%var% - (STRINGFORMAT mem='var')pattern=Hello %s, agent %03d!;" +
                                                                          "values=you,7;types=String,Integer(/STRINGFORMAT)");
        Assert.assertEquals("Hello you, agent 007! - Hello you, agent 007!", actual);
    }

    @Test
    public void test7() throws AlambicException {
        final String actual = Functions.getInstance().executeAllFunctions("(STRINGFORMAT)pattern=%010d;values=(INCREMENT)1(/INCREMENT);" +
                                                                          "types=Integer(/STRINGFORMAT)");
    ...
    public void test8() throws AlambicException {
        ...
        final String actual = Functions.getInstance().executeAllFunctions("(COMPUTEDATE){\"format\":\"dd/MM/yyyy\",\"value\":\"(NOW)dd/MM/yyyy" +
                                                                          "(/NOW)\",\"operator\":\"PLUS\",\"unit\":\"DAY\",\"operand\":\"5\"}" +
                                                                          "(/COMPUTEDATE)");
    ...
    public void test9() throws AlambicException {
        final String actual = Functions.getInstance().executeAllFunctions("(COMPUTEDATE){\"format\":\"dd/MM/yyyy\",\"value\":\"08/03/2018\"," +
                                                                          "\"operator\":\"MINUS\",\"unit\":\"DAY\",\"operand\":\"5\"}(/COMPUTEDATE)");
    ...
    public void test10() throws AlambicException {
        final String actual = Functions.getInstance().executeAllFunctions("(COMPUTEDATE){\"format\":\"dd/MM/yyyy\",\"value\":\"08/03/2018\"," +
                                                                          "\"operator\":\"MINUS\",\"unit\":\"MONTH\",\"operand\":\"5\"}" +
                                                                          "(/COMPUTEDATE)");
    ...
    public void test11() throws AlambicException {
        final String actual = Functions.getInstance().executeAllFunctions("(COMPUTEDATE){\"format\":\"dd/MM/yyyy\",\"value\":\"08/03/2018\"," +
                                                                          "\"operator\":\"PLUS\",\"unit\":\"YEAR\",\"operand\":\"4\"}(/COMPUTEDATE)");
    ...
    public void test12() throws AlambicException {
        final String actual = Functions.getInstance().executeAllFunctions("(COMPUTEDATE){\"format\":\"dd/MM/yyyy\",\"value\":\"08/03/2018\"," +
                                                                          "\"operator\":\"PLUS\",\"operand\":\"15\"}(/COMPUTEDATE)");
