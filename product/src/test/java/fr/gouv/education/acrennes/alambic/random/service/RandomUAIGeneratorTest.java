...
public class RandomUAIGeneratorTest {
    ...
    public void test1() {
        try {
            ...
            long distinctCount = entities.stream()
                    ...
                    .distinct()
                    .count();
            Assert.assertEquals(3, distinctCount);
    ...
    public void test5() {
        try {
            List<RandomEntity> entities1 = rg.getEntities("{\"blurid\":\"1\",\"count\":3,\"reuse\":\"true\",\"root\":\"029\"}", "PROCESS_TESTU",
            ...
            List<RandomEntity> entities2 = rg.getEntities("{\"blurid\":\"1\",\"count\":3,\"reuse\":\"true\",\"root\":\"029\"}", "PROCESS_TESTU",
                    UNICITY_SCOPE.PROCESS);
    ...
    public void test6() {
        try {
            List<RandomEntity> entities1 = rg.getEntities("{\"blurid\":\"1\",\"count\":1,\"reuse\":\"true\"}", "PROCESS_TESTU",
                    UNICITY_SCOPE.PROCESS);
            Assert.assertEquals(1, entities1.size());

            List<RandomEntity> entities2 = rg.getEntities("{\"blurid\":\"2\",\"count\":1,\"reuse\":\"true\"}", "PROCESS_TESTU",
                    UNICITY_SCOPE.PROCESS);
            Assert.assertEquals(1, entities2.size());

            Assert.assertNotEquals(entities1.get(0).getHash(), entities2.get(0).getHash());
        } catch (AlambicException e) {
            Assert.fail(e.getMessage());
        }
    }
