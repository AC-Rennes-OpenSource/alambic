...
public class CipherHelperTest {
    ...
    public void setUp() throws UnrecoverableKeyException, KeyStoreException, CertificateException, IOException {
        try {
             ...
             * keytool -genseckey -alias aliasaes128 -keyalg AES -keysize 128 -keypass testpass -keystore alambic.keystore -storetype JCEKS
             * -storepass testpass
             ...
             * keytool -genkeypair -alias aliasrsa1024 -keyalg RSA -keysize 1024 -keypass testpass -keystore alambic.keystore -storetype JCEKS
             * -storepass testpass
             */
