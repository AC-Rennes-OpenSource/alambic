...
ALAMBIC_HOME_PRODUCT="${ALAMBIC_HOME}/active"
ALAMBIC_HOME_ADDONS="${ALAMBIC_HOME}/addons"
ALAMBIC_ADDON_NAME=""
...
then
    ...
    ./${ALAMBIC_ADDON_SCRIPT_FILE_NAME} -d "${SCRIPT_PARAMETERS}" > ${ALAMBIC_ADDON_SCRIPT_FILE_NAME}.log 2>&1
else
